...
do
    ...
    WaitText.Text = "Loading 'TP to LevelRace' and 'Auto TowerClimb' Buttons..."
...
-- Chèn ngay sau TextButton.Parent = Frame
local keyword = "Auto TowerClimb"  -- chỉ cần chứa từ khóa
if string.find(text, keyword) or string.find(text, "TP to LevelRace") then
